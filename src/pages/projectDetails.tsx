        ...
        <div className="w-full h-full flex flex-col bg-inherit">
            {
                project == "it" ?
                    ...
                    <div className="h-3/4 bg-white shadow-md z-10 p-5 overflow-y-scroll overscroll-auto">
                        <div id="bundle-1" className="w-fit h-auto grid grid-cols-3 justify-items-center items-center">
                            {
                                imageNames1.map((img) => {
                                    return (
                                        <img className="object-contain" src={require("../../assets/exported/bundle-1/" + img + ".jpg")} />
                                    )
                                })
                            }
                        </div>
